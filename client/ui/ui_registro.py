...
def register():
    ...
    pass2 = pass2_var.get()         # Obtener el texto ingresado en el campo de confirmar contraseña
    email = email_var.get()         # Obtener el texto ingresado en el campo de email

# Imprimir los datos introducidos linea a linea
    print(username)
    print(password)
    print(pass2)
    print(email)
...
def register_menu(app):
    ...
    CTkButton(master=frame, text="Registrarse", fg_color="#601E88", hover_color="#D073F2", font=("Arial Bold", 12), text_color="#ffffff", width=225, command=register).pack(anchor="w", pady=(30, 0), padx=(25, 0))
