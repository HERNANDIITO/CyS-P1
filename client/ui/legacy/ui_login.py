...
def login_menu(app):
    ...
    CTkEntry(master=frame, width=225, fg_color="#EEEEEE", border_color="#601E88", border_width=1, text_color="#000000", corner_radius = 32, textvariable=email_var).pack(anchor="w", padx=(25, 0))
    ...
    CTkEntry(master=frame, width=225, fg_color="#EEEEEE", border_color="#601E88", border_width=1, text_color="#000000", show="*", corner_radius = 32, textvariable=password_var).pack(anchor="w", padx=(25, 0))

    CTkButton(master=frame, text="Iniciar Sesión", fg_color="#601E88", hover_color="#D18AF0", font=("Arial Bold", 12), text_color="#ffffff", corner_radius = 32, width=225, command=lambda: on_login(app)).pack(anchor="w", pady=(40, 0), padx=(25, 0))
    CTkButton(master=frame, text="Registrarse", fg_color="#9674AC", hover_color="#D18AF0", font=("Arial Bold", 12), text_color="#ffffff", corner_radius = 32, width=225, command=lambda: on_register(app)).pack(anchor="w", pady=(10, 0), padx=(25, 0))
    CTkButton(master=frame, text="Continuar con Google", fg_color="#EEEEEE", hover_color="#CCCCCC", font=("Arial Bold", 9), text_color="#601E88", corner_radius = 32, width=225, image=google_icon, command=lambda : on_google_login(app)).pack(anchor="w", pady=(20, 0), padx=(25, 0))