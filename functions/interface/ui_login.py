...
side_img_data = Image.open(".\\functions\\interface\\imgs\\side-img.png")
email_icon_data = Image.open(".\\functions\\interface\\imgs\\email-icon.png")
password_icon_data = Image.open(".\\functions\\interface\\imgs\\password-icon.png")
google_icon_data = Image.open(".\\functions\\interface\\imgs\\google-icon.png")
